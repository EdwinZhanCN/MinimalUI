...
export default defineConfig({
    ...
    title: "MinimalUI",
    description:
        "A Cross-Platform UI Framework for SPI Displays - Supporting ESP32, STM32, and Jetson platforms",
    base: "/",
    cleanUrls: true,
    ...
    themeConfig: {
            ...
            "/": [
                ...
                },
                {
                    ...
                    items: [
                        {
                            text: "ESP32 Setup",
                            link: "/development/esp32-setup",
                        },
                        {
                            text: "Hardware Connections",
                            link: "/development/hardware",
                        },
                        {
                    ...
                    items: [
                        {
                            ...
                            link: "/api/graphics-driver",
                        },
                        {
                            text: "Display Controllers",
                            link: "/api/display-controllers",
                        },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            text: "ESP32 OLED Demo",
                            link: "/examples/esp32-oled",
                        },
                        {
                            text: "Custom Components",
                            link: "/examples/custom-components",
                        },
                    ],
                },
            ],
        ...
        footer: {
            ...
            copyright: "Copyright © 2025 MinimalUI Contributors",
        },
